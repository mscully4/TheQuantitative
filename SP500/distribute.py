...
def to_pdf(filename):
    ...
    pdfkit.from_file(filename, 'DailySP500Report.pdf', options=options)
    infile = PdfFileReader('DailySP500Report.pdf', 'rb')
    print(infile.numPages)
    output = PdfFileWriter()
    output.addPage(infile.getPage(0))
    with open('/home/daily_reports/PDFs/DailySP500Report.pdf', 'wb') as fh:
        output.write(fh)
...
def send(filename):
    ...
    msg['From'] = fromaddr
    msg['To'] = toaddr
    msg['Subject'] = "Daily S&P 500 Report"
